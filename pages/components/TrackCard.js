...
import { Album, PianoOutlined, PlayCircleOutline } from '@mui/icons-material';
...
export default function TrackCard({track, onSelectTrack, playOnDeck = null}) {
            ...
            <CardContent style={{width: '100% !important', paddingBottom: '0 !important'}}>
                <Grid container spacing={2}>
                    ...
                    <Grid item md={4} xs={9} sm={4}>
                        <Typography  className={styles.trackTitle} style={{width: '100%', marginTop: '16px !important'}} gutterBottom variant="h5" component="div" noWrap>
                            {track.name}
                        </Typography>
